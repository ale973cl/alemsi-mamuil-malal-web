...
export async function registrarLogin(username:string,exitoso:boolean):Promise<void>{ await query(`INSERT INTO auditoria_acciones (fecha,usuario,accion) VALUES ($1,$2,$3)`,[new Date().toISOString(),username.trim(),exitoso?'LOGIN_EXITOSO':'LOGIN_FALLIDO']); }
