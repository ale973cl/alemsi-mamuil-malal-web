    ...
    <div className="mx-auto max-w-3xl space-y-5">
      <section className="rounded-2xl border bg-white p-6">
        ...
        <form key={q.folio||'nuevo'} action={reclamoAction} autoComplete="off" className="mt-5 space-y-3" encType="multipart/form-data">
          ...
          <select name="categoria" defaultValue="Comida" className="w-full rounded-lg border p-3"><option>Comida</option><option>Atención</option><option>Higiene</option><option>Infraestructura</option><option>Pago / deuda</option><option>Otro</option></select>
