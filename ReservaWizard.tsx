        ...
        <div className="p-5 sm:p-8">
          ...
          {etapa === 'resultado' && resultado?.ok && (
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-1 text-xs font-black uppercase tracking-[.14em] text-[#6B7570]">N.º de reserva</p><h3 className="mt-1 text-3xl font-black text-[#0E2A23]">{resultado.result.codigoReserva}</h3>
