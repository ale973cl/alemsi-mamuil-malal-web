...
export default function ConfiguracionReclamos({responsables,permisos}:{responsables:Responsable[];permisos:Permiso[]}){
  ...
  return <div className="mt-5 space-y-5">
    <section className="rounded-2xl border border-[#A6B0AA]/25 bg-[#FFFDF8] p-4">
      ...
      <p className="text-sm text-[#6B7570]">Configura una sola vez el responsable y correo activo de cada área.</p>
    ...
    <section className="rounded-2xl border border-[#A6B0AA]/25 bg-[#FFFDF8] p-4">
      ...
      <p className="text-sm text-[#6B7570]">Los permisos son independientes: VER no concede SOLUCIONAR.</p>
